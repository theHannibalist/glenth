...
def run_parser() -> dict:
    ...
    parser.add_argument ('--sub-dirs' , default=False , action='store_true', help='scan sub-directories for videos as well')
    ...
    return {'type' : args.type, 'target' : str(args.target_dir), 'all' : all , 'subs' : args.sub_dirs}
